...
cmd="taskset 0x3 ${SCRIPTPATH}/bin/bin/executor_manager -a ${REMOTE_IP} -p $PORT2 -v -f ${SCRIPTPATH}/server.json"
...
${SCRIPTPATH}/cold_benchmarker -f ${SCRIPTPATH}/server.json -r 1000 --out-file out.csv -s 1024 -n empty --recv-buf-size 32 -v  > ${SCRIPTPATH}/serverless_client_$size
